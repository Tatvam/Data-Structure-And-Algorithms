...
int main(){
    ...
    re(i,n){
        ...
        a[i].second.second++;
        ll m = 1;
        while(m<a[i].first.size()){
            char top;
            if(!s.empty())
             top = s.top();
            if(top == '(' && a[i].first[m] == ')' && !s.empty()){
                s.pop();
                a[i].second.first--;
            }
            else{
        ...
        if(a[i].second.second>0 && a[i].second.first==0){
            cntr[a[i].second.second]++;
        }
        else if(a[i].second.first>0 && a[i].second.second==0){
            cntl[a[i].second.first]++;
        }
    }
    ll ans = 0;
    re(i,n){
